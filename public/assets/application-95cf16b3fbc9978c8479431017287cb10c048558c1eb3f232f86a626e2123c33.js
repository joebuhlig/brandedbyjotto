...
$(document).on('page:change', function(event) {
  ...
  $(".size-chart-button").click(function(){
    $(".size-chart-background").fadeIn();
    $(".size-chart-wrapper").fadeIn();
  })
  $(".size-chart-wrapper, .size-chart-close").click(function(e){
    e.preventDefault();
  ...
  setTimeout(function(){
	...
	$(".image-zoom, .image-zoom-close").click(function(e){
    e.preventDefault();
...
function rotateHero(){
  if (curHero == heroImageCNT){
    var newHero = 1;
  }
  else {
    var newHero = curHero + 1;
  }
  $("#hero" + newHero).show("slide", {direction:'right'}, 300, function(){
    $("#hero" + curHero).hide();
    curHero = newHero;
  });
  setTimeout(function(){
...
(function() {
  Spree.ready(function($) {
    ...
    Spree.addImageHandlers = function() {
      ...
      return thumbnails.find('a').on('click', function(event) {
