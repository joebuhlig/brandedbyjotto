...
gem 'spree_reviews', github: 'joebuhlig/spree_reviews', branch: '~> 3-0-stable'
gem 'spree_mail_settings', github: 'spree-contrib/spree_mail_settings', branch: '~> 3-0-stable'
gem 'spree_wombat', git: 'git@github.com:spree/spree_wombat.git', branch: '~> 3-0-stable'
gem 'spree_product_assembly', github: 'joebuhlig/spree-product-assembly', branch: '~> 3-0-stable'
